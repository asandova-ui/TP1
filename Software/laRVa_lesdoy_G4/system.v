...
module SYSTEM (
	...
	output mosi,
	input  miso,	
	output fssb 	// Flash CS0

	output sck1,		// SPI1
	output mosi1,
	input  miso1,	
	output fssb1	// Flash CS1	
...
// UART CS
	// UART0
wire uartcs0;	// UART	at offset 0x00
assign uartcs0 = iocs&(ca[7:5]==3'b100); //Cambio UART0 a 0X80
	// UART1
wire uartcs1;	// UART	at offset 0x90
assign uartcs1 = iocs&(ca[7:5]==3'b1001); //Cambio UART1 a 0X90
	// UART2
wire uartcs2;	// UART	at offset 0xA0
assign uartcs2 = iocs&(ca[7:5]==3'b101); //Cambio UART2 a 0XA0


// SPI CS
	//SPI0
wire spi0cs;		// SPI	at offset 0x70
assign spi0cs  = iocs&(ca[7:5]==3'b1110);
	//SPI1
wire spi1cs;		// SPI	at offset 0x60
assign spi1cs  = iocs&(ca[7:5]==3'b1100);
...
always@*
 casex (ca[7:2])
	6'b100xx0: iodo<={24'hx,uart_do}; //dir 80cambio
	6'b100xx1: iodo<={27'hx,ove,fe,tend,thre,dv};
...
UART_CORE #(.BAUDBITS(12)) uart1 ( .clk(cclk), .txd(txd), .rxd(rxd), 
...
UART_CORE #(.BAUDBITS(12)) uart2 ( .clk(cclk), .txd(txd), .rxd(rxd), 
